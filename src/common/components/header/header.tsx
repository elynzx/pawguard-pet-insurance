    ...
    <header className="w-full h-16 md:h-20 bg-secondary-light flex justify-center items-center sticky top-0 z-50">
      <div className="w-full md:max-w-432 px-4 md:px-30 hidden md:flex items-center justify-between">
        ...
        <div className="flex gap-8 items-center">
          ...
          <button className="btn-base bg-tertiary hover:brightness-105 transition-all">Iniciar Sesión</button>
        </div>
      </div>
      ...
      <div className="flex md:hidden w-full justify-between items-center px-5">
        ...
        {isOpen && (
          <div className="absolute top-16 right-0 w-full bg-secondary-light flex flex-col items-center h-[calc(100vh-64px)] shadow-2xl animate-in fade-in slide-in-from-right-2">
