  ...
  return (
    <section className="w-full md:px-10 py-16">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-black text-c-dark-gray font-heading">
          Beneficios incluidos en <span className="text-c-blue">todos los planes</span>
        </h2>
      </div>
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
        {BENEFITS.map((benefit) => (
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-linear-to-t from-c-dark-blue via-c-dark-blue/40 to-transparent transition-opacity duration-500 group-hover:opacity-100" />
            <div className="absolute inset-0 p-8 flex flex-col justify-end">
              <div className="translate-y-16 group-hover:translate-y-0 transition-transform duration-500 ease-out">
                <div className="flex justify-center mb-4">
                  <div className="p-3 bg-white/10 backdrop-blur-md rounded-2xl border border-white/20 group-hover:bg-c-blue group-hover:border-c-blue transition-all duration-500 shadow-xl">
                ...
                <p className="text-sm text-white text-center font-semibold leading-relaxed opacity-0 group-hover:opacity-100 transition-all duration-500 delay-100">
                  {benefit.description}
                </p>
              </div>
            </div>
