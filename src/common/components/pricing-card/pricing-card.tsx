        ...
        >
            ...
            <div className="mb-8 relative z-10">
                ...
                <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-5xl font-heading font-black text-primary">{price}</span>
            ...
            <button className={`btn-base w-full transition-all active:scale-95 relative z-10 ${style.button}`}>
